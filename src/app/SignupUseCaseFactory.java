...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createUserClearUseCase(viewManagerModel, signupViewModel, clearUserDataAccessObject);
    ...
    private static ClearController createUserClearUseCase(ViewManagerModel viewManagerModel, SignupViewModel signupViewModel, ClearUserDataAccessInterface userDataAccessObject) throws IOException {
