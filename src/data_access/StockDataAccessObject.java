...
//        int new_value = user.getPortfolio().getPortfolio().get(stock.getStockSymbol());
...
//                    old_value, new_value);
//        } else {
//            user.getPortfolio().getPortfolio().put(stock.getStockSymbol(), user.getPortfolio().getPortfolio().
//                    get(stock.getStockSymbol()) + amount);
//        }
//
